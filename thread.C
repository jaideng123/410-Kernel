...
static void thread_shutdown() {
     ...
     */
    // Console::puts("Shut it down, you would shut it down \n");
    // Console::puts("You be the baddest thread around, and they notice, they notice \n");
    // Console::puts("You would shut it, hey oh \n");
    // Console::puts("These threads ain't got nothing on you \n");
